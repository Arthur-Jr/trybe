...
describe('quem sobreviveu?', () => {
  ...
  afterEach(() => {
    const names = adventure.specialists.map((specialist) => specialist.nome);
    console.log(`Os aventureiros: ${names}`);
  });

  afterAll(() => {
    console.log(`${adventure.specialists[0].nome}, the last one.`);
  });
