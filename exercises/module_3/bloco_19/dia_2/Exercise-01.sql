...
-- Parte que eu fiz:
SELECT "This is SQL Exercise, Practice and Solution" AS text;
...
SELECT CONCAT('O Projeto ', Name, ' precisou de ', Hours, ' horas para ser concluido.') AS Frase FROM Projects;
